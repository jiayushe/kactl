...
\section{Optimization tricks}
	...
	\subsection{Bit hacks}
		...
		\end{itemize}
	\subsection{Pragmas}
		\# \lstinline{#pragma GCC optimize ("Ofast")} will make GCC auto-vectorize loops and optimizes floating points better. \\
		\# \lstinline{#pragma GCC target ("avx2")} can double performance of vectorized code, but causes crashes on old machines. \\
		\# \lstinline{#pragma GCC optimize ("trapv")} kills the program on integer overflows (but is really slow).
